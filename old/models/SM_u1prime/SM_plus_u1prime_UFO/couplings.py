...
GC_52 = Coupling(name = 'GC_52',
                 value = 'complex(0,1)*gX*qXdL',
                 order = {'U1X':1})

GC_53 = Coupling(name = 'GC_53',
                 value = 'complex(0,1)*gX*qXdR',
                 order = {'U1X':1})

GC_54 = Coupling(name = 'GC_54',
                 value = 'complex(0,1)*gX*qXeL',
                 order = {'U1X':1})

GC_55 = Coupling(name = 'GC_55',
                 value = 'complex(0,1)*gX*qXeR',
                 order = {'U1X':1})

GC_56 = Coupling(name = 'GC_56',
                 value = 'complex(0,1)*gX*qXuL',
                 order = {'U1X':1})

GC_57 = Coupling(name = 'GC_57',
                 value = 'complex(0,1)*gX*qXuR',
                 order = {'U1X':1})

GC_58 = Coupling(name = 'GC_58',
                 value = 'complex(0,1)*gX*qXvL',
                 order = {'U1X':1})

GC_59 = Coupling(name = 'GC_59',
                 value = 'complex(0,1)*gX*qXvR',
                 order = {'U1X':1})
