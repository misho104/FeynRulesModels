...
GC_11 = Coupling(name = 'GC_11',
                 value = '-6*complex(0,1)*lamX',
                 order = {'1':1})

GC_12 = Coupling(name = 'GC_12',
                 value = 'complex(0,1)*gX*qxD',
                 order = {'EXT':1})

GC_13 = Coupling(name = 'GC_13',
                 value = 'complex(0,1)*gX*qxE',
                 order = {'EXT':1})

GC_14 = Coupling(name = 'GC_14',
                 value = 'complex(0,1)*gX*qxL',
                 order = {'EXT':1})

GC_15 = Coupling(name = 'GC_15',
                 value = 'complex(0,1)*gX*qxQ',
                 order = {'EXT':1})

GC_16 = Coupling(name = 'GC_16',
                 value = '2*complex(0,1)*gX**2*qxS**2',
                 order = {'EXT':2})

GC_17 = Coupling(name = 'GC_17',
                 value = 'complex(0,1)*gX*qxU',
                 order = {'EXT':1})
...
GC_41 = Coupling(name = 'GC_41',
                 value = '-6*complex(0,1)*lamX*vX',
                 order = {'1':1})

GC_42 = Coupling(name = 'GC_42',
                 value = '2*complex(0,1)*gX**2*qxS**2*vX',
                 order = {'EXT':2})
