...
V_1335 = Vertex(name = 'V_1335',
                ...
                lorentz = [ L.VVSS1 ],
                couplings = {(0,0):C.GC_72,(1,0):C.GC_72})

V_1336 = Vertex(name = 'V_1336',
                particles = [ P.g, P.g, P.sd1__tilde__, P.sd4 ],
                color = [ 'T(1,-1,3)*T(2,4,-1)', 'T(1,4,-1)*T(2,-1,3)' ],
                lorentz = [ L.VVSS1 ],
                couplings = {(0,0):C.GC_75,(1,0):C.GC_75})
