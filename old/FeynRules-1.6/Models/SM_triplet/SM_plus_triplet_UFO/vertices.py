...
V_71 = Vertex(name = 'V_71',
              particles = [ P.u, P.t, P.chi ],
              color = [ 'Epsilon(1,2,3)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_79})

V_72 = Vertex(name = 'V_72',
              particles = [ P.u__tilde__, P.t__tilde__, P.chi__tilde__ ],
              color = [ 'EpsilonBar(1,2,3)' ],
              lorentz = [ L.FFS4 ],
              couplings = {(0,0):C.GC_79})

V_73 = Vertex(name = 'V_73',
              particles = [ P.G, P.chi__tilde__, P.chi ],
              color = [ 'T(1,3,2)' ],
              lorentz = [ L.VSS1 ],
...
V_93 = Vertex(name = 'V_93',
              ...
              couplings = {(0,0):C.GC_35,(0,1):C.GC_48})
...
V_96 = Vertex(name = 'V_96',
              ...
              couplings = {(0,0):C.GC_109,(0,1):C.GC_82})
...
V_98 = Vertex(name = 'V_98',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS3, L.FFS4 ],
              couplings = {(0,0):C.GC_100,(0,1):C.GC_84})

V_99 = Vertex(name = 'V_99',
              particles = [ P.s__tilde__, P.u, P.phi__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS3, L.FFS4 ],
              couplings = {(0,0):C.GC_110,(0,1):C.GC_95})

V_100 = Vertex(name = 'V_100',
               particles = [ P.s__tilde__, P.c, P.phi__minus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_77,(0,1):C.GC_96})
...
V_102 = Vertex(name = 'V_102',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_111,(0,1):C.GC_71})

V_103 = Vertex(name = 'V_103',
               particles = [ P.b__tilde__, P.c, P.phi__minus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_78,(0,1):C.GC_72})

V_104 = Vertex(name = 'V_104',
               particles = [ P.b__tilde__, P.t, P.phi__minus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_102,(0,1):C.GC_73})
...
V_144 = Vertex(name = 'V_144',
               ...
               couplings = {(0,0):C.GC_35,(0,1):C.GC_49})
...
V_162 = Vertex(name = 'V_162',
               ...
               couplings = {(0,0):C.GC_36,(0,1):C.GC_48})
