...
MxW = Parameter(name = 'MxW',
                ...
                type = 'real',
                value = 200,
                texname = 'M_{\\text{Superscript}[W,\\prime ]}',
                lhablock = 'FRBlock',
                lhacode = [ 1 ])
...
WxW = Parameter(name = 'WxW',
                ...
                type = 'real',
                value = 0,
                texname = 'W_{\\text{Superscript}[W,\\prime ]}',
                lhablock = 'FRBlock',
                lhacode = [ 2 ])
...
MxZ = Parameter(name = 'MxZ',
                ...
                type = 'real',
                value = 200,
                texname = 'M_{\\text{Superscript}[Z,\\prime ]}',
                lhablock = 'FRBlock',
                lhacode = [ 3 ])
...
WxZ = Parameter(name = 'WxZ',
                ...
                type = 'real',
                value = 0,
                texname = 'W_{\\text{Superscript}[Z,\\prime ]}',
                lhablock = 'FRBlock',
                lhacode = [ 4 ])
...
gWprimeL = Parameter(name = 'gWprimeL',
                     ...
                     type = 'real',
                     value = 1.,
                     texname = 'g_{L \\text{Superscript}[W,\\prime ]}',
                     lhablock = 'FRBlock',
                     lhacode = [ 5 ])
...
gWprimeR = Parameter(name = 'gWprimeR',
                     ...
                     type = 'real',
                     value = 1.,
                     texname = 'g_{R \\text{Superscript}[W,\\prime ]}',
                     lhablock = 'FRBlock',
                     lhacode = [ 6 ])
...
gZprimeUT = Parameter(name = 'gZprimeUT',
                      ...
                      type = 'real',
                      value = 1.,
                      texname = 'g_{\\text{UT} \\text{Superscript}[Z,\\prime ]}',
                      lhablock = 'FRBlock',
                      lhacode = [ 7 ])
...
gZprimeUU = Parameter(name = 'gZprimeUU',
                      ...
                      type = 'real',
                      value = 1.,
                      texname = 'g_{\\text{UU} \\text{Superscript}[Z,\\prime ]}',
                      lhablock = 'FRBlock',
                      lhacode = [ 8 ])
