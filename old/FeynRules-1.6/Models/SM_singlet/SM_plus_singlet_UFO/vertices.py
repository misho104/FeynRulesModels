...
V_71 = Vertex(name = 'V_71',
              particles = [ P.t__tilde__, P.u, P.chi__tilde__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_78})

V_72 = Vertex(name = 'V_72',
              particles = [ P.b__tilde__, P.u, P.chi__plus____tilde__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_78})

V_73 = Vertex(name = 'V_73',
              particles = [ P.u__tilde__, P.t, P.chi ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS4 ],
              couplings = {(0,0):C.GC_78})

V_74 = Vertex(name = 'V_74',
              particles = [ P.u__tilde__, P.b, P.chi__plus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS4 ],
              couplings = {(0,0):C.GC_78})
...
V_96 = Vertex(name = 'V_96',
              ...
              couplings = {(0,0):C.GC_108,(0,1):C.GC_81})
...
V_98 = Vertex(name = 'V_98',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS3, L.FFS4 ],
              couplings = {(0,0):C.GC_99,(0,1):C.GC_83})

V_99 = Vertex(name = 'V_99',
              particles = [ P.s__tilde__, P.u, P.phi__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS3, L.FFS4 ],
              couplings = {(0,0):C.GC_109,(0,1):C.GC_94})

V_100 = Vertex(name = 'V_100',
               particles = [ P.s__tilde__, P.c, P.phi__minus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_76,(0,1):C.GC_95})
...
V_102 = Vertex(name = 'V_102',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_110,(0,1):C.GC_70})
...
V_104 = Vertex(name = 'V_104',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS3, L.FFS4 ],
               couplings = {(0,0):C.GC_101,(0,1):C.GC_72})
